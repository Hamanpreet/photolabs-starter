...
const PhotoDetailsModal = ({setModalVisible, selectedPhoto, favoritedPhotos, 
  showFav, toggleFavorite}) => {
  const closeModal = () => {
  ...
  return (
    <div className="photo-details-modal">
      ...
      <PhotoFavButton  isFavorited={favoritedPhotos.some((photo) => photo.id === selectedPhoto.id)}
